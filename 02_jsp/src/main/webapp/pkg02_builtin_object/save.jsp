...
<%
  ...
  // 업로드 파일명
  String uploadName = title + "_" + createdAt.replace("-", "_") + "_" + ip.replace(":", "_") + ".txt"; //ip4는 . ip6는 : 구분이라서 오류 한번 떳음 .->  :로 바꿔줌
  ...
  // 파일 확인을 위한 페이지로 이동하기
  response.sendRedirect(request.getContextPath() + "/pkg02_builtin_object/confirm.jsp"); //자바 영역. 
