...
public class BoardDaoImpl implements BoardDao {
    ...
    public int insertBoard(BoardDto board) {
        ...
        try {
            ...
            String sql = "INSERT INTO BOARD_T(BOARD_NO, TITLE, CONTENTS, MODIFIED_AT, CREATED_AT) VALUED(BOARD_SEQ.NEXTVAL, ?, ?, CURRENT_DATE, CURRENT_DATE)";
    ...
    public List<BoardDto> selectBoardList(Map<String, Object> params) {
        ...
        try {
          ...
          ps = con.prepareStatement(sql);
          ps.setInt(1, (int)params.get("begin"));   // Map 다운캐스팅
