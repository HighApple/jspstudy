...
public class GetData2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    urlBuilder.append("?serviceKey=").append(URLEncoder.encode("P5oSSlpA5J2Rs6qvjb4RDj1hLJfuzYr5UEWvl8b%2Bk6BlKej4x0GkWtaVwGov4rPDsIQIo0C4W9%2BJISx1mVva4Q%3D%3D", "UTF-8"));
        ...
        try {
           ...
           // HttpURLConnection 객체
            ...
            if(!resultCode.equals("00")) {  // 정상 응답("00")dl dkslaus 예외 발생
